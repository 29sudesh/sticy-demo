 ...
 */
abstract class StickyAdapter<SVH : ViewHolder?, VH : ViewHolder?> : RecyclerView.Adapter<VH>() {
    /**
     ...
     */
    abstract fun onBindHeaderViewHolder(holder: ViewHolder?, headerPosition: Int)
